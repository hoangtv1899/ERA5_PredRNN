...
def main(var, years=[2018], month_start=9, month_end=10, path='/scratch/08589/hvtran/baselines/tigge/raw/', ens=False, grid = 0.25,
        stepi = 6):

    step = ""
    for sub_step in np.arange(0,240+1,stepi):
        step += str(sub_step)+"/"
    step = step[:-1]
